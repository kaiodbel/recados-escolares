 ...
 */
export declare const RealmProvider: import("./RealmProvider").DynamicRealmProvider;
/**
 ...
 */
export declare const useRealm: import("./useRealm").UseRealmHook;
/**
 ...
 */
export declare const useQuery: import("./useQuery").UseQueryHook;
/**
 ...
 */
export declare const useObject: import("./useObject").UseObjectHook;
/**
 ...
 */
export declare const useProgress: ({ direction, mode }: {
    direction: Realm.ProgressDirection;
    mode: Realm.ProgressMode;
}) => number | null;
export { Realm };
